            ...
            if (constraintElements && constraintElements.size() > 0) {
                ...
                while (cIt.hasNext()) {
                    ...
                    if (tType.equals("variable")) {
                        query.append("&" + constraint.getAsString());  //op is now <, <=, ...
                        ...
                        query.append("&" + constraint.getAsERDDAPString());  //op is now <, <=, ...
                    }
                }
            }
            ...
            if (qualifierList) {
                for (int i = 0; i < qualifierList.size(); i++) {
                    ...
                    if (dq.isDistinct()) {
                        ...
                        query.append("&" + dq.getType() + "(\"")
                        List<String> vs = dq.getVariables()
                        for (int j = 0; j < vs.size(); j++) {
                            query.append(vs.get(j))
                            if (j < vs.size() - 1)
                                query.append(",")
                        }
                        query.append("\")")
            ...
            if (xlo.length() > 0 && xhi.length() > 0) {
                ...
                if (Math.abs(xhiDbl - xloDbl) < 355.0d) {
                    ...
                    if ( lonConstraint.size() == 1 )
                        query.append(lonConstraint.get(0))
