...
import pmel.sdig.las.client.openlayers.DrawSingleFeature;
import pmel.sdig.las.client.openlayers.DrawSingleFeatureOptions;
import pmel.sdig.las.client.openlayers.DrawSingleFeature.FeatureAddedListener;
...
public class OLMapWidget extends Composite {
    ...
    private void init(String height, String width, String tile_url, String layer) {
        ...
        resetButton = new PushButton(resetButtonUp, resetButtonDown,
                new ClickHandler() {
                    ...
                    public void onClick(ClickEvent event) {
                        ...
                        eventBus.fireEventFromSource(new MapChangeEvent(-90., 90, -180, 180), resetButton);
                    }
        ...
        buttonPanel.addStyleName("OL_MAP-nopad");
        ...
        buttonPanel.setCellHeight(helpButton, "24px");
        buttonPanel.setCellHeight(resetButton, "24px");
        buttonPanel.setCellHeight(editButton, "24px");
        buttonPanel.setCellHeight(panButton, "24px");
        buttonPanel.setCellHeight(drawButton, "24px");
        buttonPanel.setCellHeight(zoomInButton, "24px");
        buttonPanel.setCellHeight(zoomFullButton, "24px");
        buttonPanel.setCellHeight(zoomOutButton, "24px");
        buttonPanel.setCellHeight(regionButton, "24px");

        buttonPanel.setCellWidth(helpButton, "28px");
        buttonPanel.setCellWidth(resetButton, "28px");
        buttonPanel.setCellWidth(editButton, "28px");
        buttonPanel.setCellWidth(panButton, "28px");
        buttonPanel.setCellWidth(drawButton, "28px");
        buttonPanel.setCellWidth(zoomInButton, "28px");
        buttonPanel.setCellWidth(zoomFullButton, "28px");
        buttonPanel.setCellWidth(zoomOutButton, "28px");
        buttonPanel.setCellWidth(regionButton, "28px");

        buttonPanel.addStyleName("OL_MAP-fixed");
        ...
        dockPanel.addStyleName("OL_MAP-nopad");
    ...
    public void setNamedRegions(JavaScriptObject r) {
        ...
        if (rs != null) {
            ...
            if (regions != null) {
                List<Region> wire_regions = new ArrayList<Region>();
                for (int i = 0; i < regions.size(); i++) {
                    JSONObject region = regions.get(i).isObject();
                    if (region != null) {
                        Region rg  = new Region();
                        rg.setName(region.get("name").isString()
                                .stringValue());
                        rg.setWestLon(Double.valueOf(region
                                .get("xlo").isString().stringValue()));
                        rg.setEastLon(Double.valueOf(region
                                .get("xhi").isString().stringValue()));
                        rg.setSouthLat(Double.valueOf(region
                                .get("ylo").isString().stringValue()));
                        rg.setNorthLat(Double.valueOf(region
