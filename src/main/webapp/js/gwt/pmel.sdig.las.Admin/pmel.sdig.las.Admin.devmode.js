...
var __gwtModuleFunction = $wnd.pmel_sdig_las_Admin;
...
function getCodeServer() {
  ...
  if (idx >= 0) {
    ...
    idx = query.indexOf("gwt.codesvr.pmel.sdig.las.Admin=");
    idx += (13 + "pmel.sdig.las.Admin".length);  // 
  }
  if (idx >= 0) {
...
//# sourceURL=pmel.sdig.las.Admin-0.js
